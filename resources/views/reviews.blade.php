          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="col-md-2 pull-right my-2">
                <a href="{{route('reviews.add')}}"><button type="button" class="btn btn-sm btn-outline-primary btn-block"><i class="fa fa-add"></i> Add</button></a>
              </div>
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('reviews.view',$data->slug)}}" class="btn btn-success btn-sm text-white">View</a>
                      <a href="{{route('reviews.edit',$data->slug)}}" class="btn btn-primary btn-sm text-white">Edit</a>
                      @if($data->status == 1)
                      <a href="{{route('reviews.deactivate',$data->slug)}}" class="btn btn-secondary btn-sm text-white">Deactivate</a>
                      @else
                      <a href="{{route('reviews.activate',$data->slug)}}" class="btn btn-warning btn-sm text-white">Activate</a>
                      @endif
                      <a onclick="return deleteAction();" href="{{route('reviews.delete',$data->slug)}}" class="btn btn-danger btn-sm text-white">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                  @endif
