              ...
              <div class="card-body">
                <div class="card-body">
                  ...
                  <div class="col-md-2 float-sm-right my-2">
                    <a href="{{route('package200.all')}}"><button type="button" class="btn btn-sm btn-primary btn-block text-white btn-inline"><i class="fa fa-arrow-left"></i> Back to Posts</button></a>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
