              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('facility.view',$data->slug)}}" class="btn btn-success btn-sm text-white">View</a>
                      <a href="{{route('facility.edit',$data->slug)}}" class="btn btn-primary btn-sm text-white">Edit</a>
                      @if($data->status == 1)
                      <a href="{{route('facility.deactivate',$data->slug)}}" class="btn btn-secondary btn-sm text-white">Deactivate</a>
                      @else
                      <a href="{{route('facility.activate',$data->slug)}}" class="btn btn-warning btn-sm text-white">Activate</a>
                      @endif
                      <a onclick="return deleteAction();" href="{{route('facility.delete',$data->slug)}}" class="btn btn-danger btn-sm text-white">Delete</a>
                    </td>
                  </tr>
                  @endforeach
                  @endif
