            ...
            <div class="card-body">
              <div class="card-body">
                ...
                <div class="col-md-2 float-sm-right my-2">
                  <a href="{{route('postsworker.all')}}"><button type="button" class="btn btn-sm btn-primary btn-block text-white btn-inline"><i class="fa fa-arrow-left"></i> Back to Posts</button></a>
                </div>
                <form method="POST" action="{{route('postsworker.update',$data->slug)}}" enctype="multipart/form-data">
                  @csrf()
                  <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="img-wrap"  style="max-width:210px">
                      <a onclick="return deleteAction();" href="{{route('postsworker.deletepostimage',$data->slug)}}"><span class="close deletelogos">&times;</span></a>
